...
/**
 * implementation of content provider, based on sqlite, contains one table with repositories
 */
public class RepoProvider extends ContentProvider {
    private static final String PROVIDER_NAME   = "in.flinbor.github.publicRepositories.model.RepoProvider";
    ...
    public static final String isFork          = "isFork";
    ...
    private static final String DATABASE_NAME = "reposDB";
